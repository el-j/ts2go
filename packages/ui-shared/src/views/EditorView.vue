      ...
      <div class="border-b border-gray-200 dark:border-gray-700 px-6 py-3 flex items-center gap-4">
        ...
        >
          ...
          <span
            ...
            class="ml-1 text-xs bg-primary-600 text-white px-2 py-0.5 rounded-full"
          >
          ...
          <div class="flex-1">
            <div class="flex justify-between text-sm mb-1">
              <div class="flex items-center gap-3">
                ...
                <span
                  v-if="transpilerStore.status.processingSpeed"
              ...
              <div class="flex items-center gap-3">
                <span
                  >{{ transpilerStore.status.filesProcessed }} /
                  {{ transpilerStore.status.totalFiles }} files</span
                >
                <span
                  v-if="transpilerStore.formattedTimeRemaining"
                  class="text-xs text-gray-500 dark:text-gray-400"
                >
