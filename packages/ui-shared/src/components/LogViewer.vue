<template>
  <div class="log-viewer flex flex-col h-full">
    <!-- Header -->
    <div
      class="bg-gray-100 dark:bg-gray-900 px-4 py-2 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between"
    >
      ...
      <div class="flex items-center gap-2">
        ...
        <Button
          ...
          :class="[
            ...
            autoScroll ? 'bg-primary-600 text-white' : 'bg-gray-200 dark:bg-gray-700',
          ]"
    ...
    <div ref="logsContainer" class="flex-1 overflow-auto p-4 space-y-1 text-sm font-mono">
      ...
      >
        ...
        <span :class="getLevelClass(log.level)" class="mx-2 font-bold uppercase">{{
          log.level
        }}</span>
